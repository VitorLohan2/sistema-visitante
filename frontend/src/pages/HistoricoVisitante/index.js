...
export default function HistoricoVisitante() {
  ...
  useEffect(() => {
    ...
    const fetchHistory = async () => {
      try {
        ...
        // ✅ ATUALIZADO: Usando nova rota /visitantes/historico
        // O interceptor do axios já adiciona o Bearer token automaticamente
  ...
  if (loading)
    return <Loading progress={progress} message="Carregando histórico..." />;
